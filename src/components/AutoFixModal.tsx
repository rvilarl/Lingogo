              ...
              <div className="space-y-4">
                ...
                {progress.currentPhrase && (
                  <div className="bg-slate-700/30 rounded-lg p-3 border border-slate-600">
                    ...
                    <div className="text-sm text-white truncate">{progress.currentPhrase}</div>
                  </div>
                )}
              </div>
            )}
            ...
            {status === 'completed' && (
              <div className="space-y-4">
                ...
                <div className="bg-green-500/10 rounded-lg p-4 border border-green-500/20">
                  {completedMessage && (
                    <pre className="text-sm text-green-100 whitespace-pre-wrap font-mono">{completedMessage}</pre>
                  )}
                </div>
            ...
            {status === 'error' && error && (
              <div className="space-y-3">
                <div className="bg-red-500/10 rounded-lg p-4 border border-red-500/20">
                  <p className="text-sm text-red-200 mb-2">Не удалось автоматически исправить карточки:</p>
                  <p className="text-xs text-red-300 bg-red-900/30 p-3 rounded font-mono">{error}</p>
                </div>
              </div>
            )}
          </div>
